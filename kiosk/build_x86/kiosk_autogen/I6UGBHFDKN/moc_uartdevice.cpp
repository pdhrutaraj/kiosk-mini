...
static constexpr auto qt_meta_stringdata_CLASSUartDeviceENDCLASS = QtMocHelpers::stringData(
    "UartDevice",
    "bytesReceived",
    "",
    "data",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSUartDeviceENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSUartDeviceENDCLASS_t qt_meta_stringdata_CLASSUartDeviceENDCLASS = {
    {
        QT_MOC_LITERAL(0, 10),  // "UartDevice"
        QT_MOC_LITERAL(11, 13),  // "bytesReceived"
        QT_MOC_LITERAL(25, 0),  // ""
        QT_MOC_LITERAL(26, 4),  // "data"
        QT_MOC_LITERAL(31, 11)   // "onReadyRead"
    },
    "UartDevice",
    "bytesReceived",
    "",
...
void UartDevice::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (UartDevice::*)(QByteArray );
...
// SIGNAL 0
void UartDevice::bytesReceived(QByteArray _t1)
{
