...
Q_CONSTINIT static const qt_meta_stringdata_CLASSBarcodeModelENDCLASS_t qt_meta_stringdata_CLASSBarcodeModelENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(13, 14),  // "barcodeUpdated"
        QT_MOC_LITERAL(28, 0),  // ""
        QT_MOC_LITERAL(29, 9),  // "setResult"
        QT_MOC_LITERAL(39, 4),  // "text"
        QT_MOC_LITERAL(44, 6),  // "format"
...
void BarcodeModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->barcodeUpdated(); break;
        case 1: _t->setResult((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1])),(*reinterpret_cast< std::add_pointer_t<QString>>(_a[2]))); break;
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &BarcodeModel::barcodeUpdated; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void BarcodeModel::barcodeUpdated()
{
